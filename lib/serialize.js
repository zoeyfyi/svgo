...
var Serialize = function(data, opts) {
    if (!(this instanceof Serialize)) {
        return new Serialize(data, opts);
    }
...
Serialize.prototype.indent = function() {
    var indent = '';
...
Serialize.prototype.doctype = function(doctype) {
    return this.opts.doctypeStart +
           doctype +
           this.opts.doctypeEnd;
};

Serialize.prototype.processingInstruction = function(inst) {
...
Serialize.prototype.cdata = function(cdata) {
    return this.opts.cdataStart +
           cdata +
           this.opts.cdataEnd;
};

Serialize.prototype.comment = function(comment) {
    return this.opts.commentStart +
           comment +
           this.opts.commentEnd;
};

Serialize.prototype.elem = function(data) {
...
Serialize.prototype.attrs = function(elem) {
    var attrs = '';
...
Serialize.prototype.text = function(text) {
    // for (var entity in this.opts.entities) {
    //     text = text.split(entity).join(this.opts.entities[entity]);
    // }
    return this.indent() +
           this.opts.textStart +
           text +
